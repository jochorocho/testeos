...
//console.log("hola, esta es el console.log");
...
console.log ("deberías tener " + miedad + " años")
*/
...
function calcularSalarioDiario (salarioSemanal, diasEnUnaSemana){
    return  salarioSemanal/diasEnUnaSemana
}

function calcularSalarioHora (salarioDiario, horasEnUnDia) {
    return salarioDiario/horasEnUnDia
}

function calcularSalarioSemanal (salarioMensual, semanasEnUnMes){
    return salarioMensual/semanasEnUnMes
}

    function calcularSalarioAnual (salarioMensual,mesesEnUnAnio){
        return salarioMensual*mesesEnUnAnio 
}

let horasEnUnDia = prompt ("Cuántas horas por día trabajás?")
const mesesEnUnAnio = 12
let diasEnUnaSemana = prompt ("Cuántos días a la semana trabajás?")
const semanasEnUnMes = 4

let salarioMensual = prompt("Cuál es tu salario mensual?")
